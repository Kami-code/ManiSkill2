...
from mani_skill2.agents.configs.xarm_allegro import defaults
...
class XarmAllegro(BaseAgent):
    _config: defaults.XarmAllegroDefaultConfig

    @classmethod
    def get_default_config(cls):
        return defaults.XarmAllegroDefaultConfig()
