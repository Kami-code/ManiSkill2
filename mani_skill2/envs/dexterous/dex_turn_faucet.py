...
from mani_skill2.agents.robots.xarm_allegro import XarmAllegro
...
class DexTurnFaucetBaseEnv(BaseEnv):
    SUPPORTED_ROBOTS = {"XarmAllegro": XarmAllegro}
    agent: XarmAllegro
    ...
    def _initialize_agent(self):
        ...
        elif self.robot_uid == 'XarmAllegro':
...
@register_env("DexTurnFaucet-v0", max_episode_steps=200)
class DexTurnFaucetEnv(DexTurnFaucetBaseEnv):
